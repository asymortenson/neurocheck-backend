...
func (app *application) queryMissingError(w http.ResponseWriter, r *http.Request, params ...string) {
	var sliceParams []string

	sliceParams = append(sliceParams, params...)

	message := "missing query parameters: " + strings.Join(sliceParams, ", ")
